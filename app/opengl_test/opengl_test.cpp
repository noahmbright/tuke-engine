...
int main() {
  ...
  u32 program = shader_handles_to_gl_program(SHADER_HANDLE_COMMON_TRIANGLE_BRINGUP_VERT,
                                             SHADER_HANDLE_COMMON_TRIANGLE_BRINGUP_FRAG);

  u32 transformed_program = shader_handles_to_gl_program(SHADER_HANDLE_COMMON_UNIFORM_BRINGUP_VERT,
                                                         SHADER_HANDLE_COMMON_UNIFORM_BRINGUP_FRAG);

  u32 textured_quad_program = shader_handles_to_gl_program(SHADER_HANDLE_COMMON_TEXTURED_QUAD_BRINGUP_VERT,
